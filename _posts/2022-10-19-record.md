...
Ogni insieme di valori di un tipo record è definito **istanza** del tipo record.

Si può pensare al record come alla planimetria di un oggetto. Tutte le istanze
...
<!-- <details>
    <summary>
        <h3 id="typedef">
            Usare una struttura senza anteporre
            <code class="language-plaintext highlighter-rouge">struct</code>
        </h3>
        (avanzato)
    </summary>
